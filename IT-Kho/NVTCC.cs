...
namespace IT_Kho
{
    public partial class NVTCC : DevExpress.XtraEditors.XtraUserControl
    {
        public NVTCC()
        {
            InitializeComponent();
        }
        private static NVTCC _instance;

        public static NVTCC Instance
        {
            get
            {
                if (_instance == null)
        ...
        private void NVTCC_Load(object sender, EventArgs e)
        {
            hien();
